...
class Instabot:
    ...
    def login(self):
        ...
        save_info_button = self.driver.find_element_by_xpath(
            "//*[contains(@class,'sqdOP yWX7d    y3zKF     ')]")
    ...
    def profile(self):
        self.driver.find_element_by_xpath(
            "/html/body/div[1]/section/nav/div[2]/div/div/div[3]/div/div[5]").click()
        time.sleep(1)
    ...
    def follow(self):
        ...
        for i in range(10):
            follow_button = self.driver.find_element_by_xpath(
                "//*[contains(@class,'sqdOP  L3NKy   y3zKF     ')]")
            follow_button.click()
            time.sleep(2)
    ...
    def follow_nav_user(self, user):
        ...
        self.nav_user(user)
        time.sleep(1)
        follow_button_nav = self.driver.find_element_by_xpath(
    ...
    def follow_suggested_users(self):
        ...
        self.driver_func()
        see_all_users = self.driver.find_element_by_xpath(
            "//*[contains(@class,'_7UhW9  PIoXz        qyrsm KV-D4          uL8Hv         ')]")
        see_all_users.click()
        time.sleep(2)
        self.follow()
        self.profile()
    ...
    def unfollow(self):
        ...
        for i in range(5):
            unfollow_button = self.driver.find_element_by_xpath(
                "//*[contains(@class,'sqdOP  L3NKy    _8A5w5    ')]")
            unfollow_button.click()
            time.sleep(1)
            unfollow_confirmation = self.driver.find_element_by_xpath(
                "//*[contains(@class,'aOOlW -Cab_   ')]")
    ...
    def unfollow_nav_user(self, user):
        ...
        time.sleep(1)
        self.driver.find_element_by_xpath(
            "//*[contains(@class,'_5f5mN    -fzfL     _6VtSN     yZn4P   ')]").click()
        time.sleep(1)
        unfollow_button = self.driver.find_element_by_xpath(
            "//*[contains(@class,'aOOlW -Cab_   ')]")
        unfollow_button.click()
    ...
    def like_posts(self):
        ...
        for i in range(20):
            ...
            like_button.click()
            time.sleep(1)
            next_img = self.driver.find_element_by_xpath(
                "//*[contains(@class,' _65Bje  coreSpriteRightPaginationArrow')]")
            next_img.click()
